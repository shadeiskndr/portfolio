      ...
      <div className="flex flex-col gap-12 md:flex-row">
        ...
        <div className="flex max-w-3xl flex-grow flex-col justify-center gap-8 md:order-first md:items-start md:justify-center 2xl:gap-12">
          <div className="flex flex-col gap-2">
            ...
            <Typography>
              Versatile and motivated IT bachelor fresh graduate with an
              affinity for software development ranging from web, mobile and
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Typography>
                Searching for entry-level positions as a Software Developer or
                any related IT position.
              </Typography>
            </div>
          </div>
