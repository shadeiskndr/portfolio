        ...
        <div className="flex max-w-xl flex-col gap-6 sm:order-last md:order-first lg:order-first">
          ...
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">CGPA: 3.78/4.00</Typography>
            </ul>
            <ul className="flex list-inside list-disc flex-col gap-2">
          ...
          <Typography variant="body1">Universiti Teknologi MARA</Typography>
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">CGPA: 3.67/4.00</Typography>
            </ul>
            <ul className="flex list-inside list-disc flex-col gap-2">
          ...
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">Result: 3A+, 6A, 1B+</Typography>
            </ul>
            <ul className="flex list-inside list-disc flex-col gap-2">
