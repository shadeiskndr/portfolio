  ...
  const content = (
    <Wrapper
      ...
      className={cn(
        inline
          ? "inline"
          : "flex items-center gap-1 font-mono text-4xl text-black tracking-tight md:text-6xl dark:text-white",
        textClassName
      )}
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <motion.span
        ...
        className={cn(
          inline
            ? "ml-0.5 inline-block h-[0.85em] w-px translate-y-[0.1em] bg-current align-baseline"
            : "inline-block h-[1em] w-0.75 bg-black dark:bg-white",
          cursorClassName
        )}
        transition={{
          duration: 1,
