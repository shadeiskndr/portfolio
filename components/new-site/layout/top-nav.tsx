...
export default function TopNav() {
  ...
  return (
    <nav className="flex items-center justify-between gap-3 border-b px-6 py-4 lg:px-10">
      <SidebarDrawer />
      <ul className="hide-scrollbar flex flex-1 items-center gap-1 overflow-x-auto">
        {NAV_LINKS.map((link) => {
          const active =
