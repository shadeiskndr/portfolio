...
export default function ResumeViewer({ fileUrl }: ResumeViewerProps) {
  ...
  return (
    <>
      <div
        ref={containerRef}
        className="min-h-0 flex-1 overflow-auto bg-muted/50 px-3 py-4 sm:px-6"
      >
      ...
      <div className="flex items-center justify-between gap-2 border-foreground/10 border-t px-5 py-3">
        <Button
          variant="outline"
          size="sm"
          nativeButton={false}
          ...
          render={<a href={fileUrl} download aria-label="Download resume" />}
        >
